...
sudo rm -rf ~/.config/openbox/lxde-rc.xml
...
User=$OE_USER
Group=$OE_USER
ExecStart=  /home/$OE_USER/script.sh
Restart=always
...
mv ~/chromiumkiosk.service /etc/systemd/system/chromiumkiosk.service
